...
export default function ChatBot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 ">
      <Card className="w-96 h-[500px] shadow-2xl border-0 bg-card/95 backdrop-blur-sm pt-">
        <CardHeader className="flex flex-row items-center justify-between pt-4 space-y-0 pb-3 border-b bg-gradient-to-r from-primary to-primary/80 text-primary-foreground rounded-t-xl">
        ...
        {!isMinimized && (
          <>
            <CardContent className="flex-1 p-0 overflow-hidden">
              <div className="h-[380px] overflow-y-auto p-4 space-y-4 hide-scrollbar">
            ...
            <CardFooter className="p-4 border-t bg-muted/30">
              <div className="flex gap-3 w-full">
                <Input
                  ...
                  className="flex-1 border-border bg-background focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm"
                />
                <Button
                  onClick={handleSendMessage}
                  disabled={!inputValue.trim() || isTyping}
                  size="sm"
                  className="bg-primary hover:bg-primary/90 text-primary-foreground border-0 h-10 w-10 p-0"
                >
